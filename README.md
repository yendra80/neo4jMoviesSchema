...
## **Set up Neo4j Enterprise on VM**
  ...
  I set up cloud environment under AWS EC2 with Ubuntu OS to install Neo4j Enterprise Edition with the following major key steps. Official documentation can be seen from https://neo4j.com/docs/operations-manual/current/installation/linux/debian/
...
![CypherShell](https://user-images.githubusercontent.com/54164349/167445701-f122bac7-25a0-442c-b2f3-595fcd4f1421.PNG)
  ...
  <img src="https://user-images.githubusercontent.com/54164349/167448353-5a6f9f2b-19c6-486c-876e-366390ae8349.png" width="800" height="300">
  ...
  <img src="https://user-images.githubusercontent.com/54164349/167449198-11c6eecc-f4ed-41a3-886a-abdc2b1bbf96.png" width="800" height="300">
...
3 python code was setup with the following purposes: 
  > [LoadMovies.py](/python/LoadMovies.py) will load and create the node for Movie data
  > 
  > [LoadActors.py](/python/LoadActors.py) will create the Person node, Actors label and create relationship between Person, Actors & Movie node through ACTED_IN
  > 
  > [LoadDirectors.py](/python/LoadDirectors.py) will merge into Person node, create Director label and create relationship between Person, Director and Movie through DIRECTED

Use the following command to run code:
  > python [LoadMovies.py](/python/LoadMovies.py)
  > 
  > python [LoadActors.py](/python/LoadActors.py)
  > 
  > python [LoadDirectors.py](/python/LoadDirectors.py)
